...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_SerialWidget_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_SerialWidget_t qt_meta_stringdata_SerialWidget = {
    {
QT_MOC_LITERAL(0, 0, 12), // "SerialWidget"
QT_MOC_LITERAL(1, 13, 17), // "cleanRecvEditSlot"
QT_MOC_LITERAL(2, 31, 0) // ""

    },
    "SerialWidget\0cleanRecvEditSlot\0"
};
...
void SerialWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SerialWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->cleanRecvEditSlot(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
QT_INIT_METAOBJECT const QMetaObject SerialWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_SerialWidget.data,
    qt_meta_data_SerialWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *SerialWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SerialWidget.stringdata0))
