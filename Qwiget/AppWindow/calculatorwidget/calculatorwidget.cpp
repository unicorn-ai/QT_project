...

{
    ...
    connect(pbt1, &QPushButton::clicked, this, &calculatorwidget::pbclose);

}
void calculatorwidget::pbclose()
{
    this->close();
    this->deleteLater();
}
...
void calculatorwidget::initUi()
{
    ...
    setLayout(pLayout);
    CommonHelper::setStyleSheet(":/calculatorwidget/style/default.qss", this);
}
