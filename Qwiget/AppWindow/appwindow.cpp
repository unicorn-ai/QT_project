...
void AppWindow::ui_init()

{    //    screenWidth=list_screen.at(0)->geometry().width();
    //    screenHeigh=list_screen.at(0)->geometry().height();

    this->resize(screenWidth, screenHeigh);
    this->setMinimumSize(screenWidth, screenHeigh);
    ...
    connect(mid_pushButton[1], &QPushButton::clicked, this, &AppWindow::pbt_mid1);
    connect(mid_pushButton[2], &QPushButton::clicked, this, &AppWindow::calculatorBtnClicked);
    connect(mid_pushButton[3], &QPushButton::clicked, this, &AppWindow::musicBtnClicked);
    connect(mid_pushButton[4], &QPushButton::clicked, this, &AppWindow::videoBtnClicked);
}

void AppWindow::calculatorBtnClicked()
{
...
void AppWindow::musicBtnClicked()
{
    //pushButton->setText("计算器");
...
void AppWindow::videoBtnClicked()
{
    //pushButton->setText("计算器");
